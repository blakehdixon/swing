...
var computeDirection = function computeDirection(
  ...
  var isLeftDirection =
    fromX < 0 ? _Direction2.default.LEFT : _Direction2.default.RIGHT;
  var isUpDirection =
    fromY < 0 ? _Direction2.default.UP : _Direction2.default.DOWN;
...
var Card = function Card(stack, targetElement, prepend) {
  ...
  var construct = function construct() {
    ...
    mc.on("panstart", function(event) {
      if (targetElement.getAttribute("side") == "front") return;
      isPanning = true;
    ...
    springThrowIn.addListener({
      ...
      onSpringUpdate: function onSpringUpdate(spring) {
        ...
        var coordianteX = _rebound2.default.MathUtil.mapValueInRange(
          value,
          0,
          1,
          lastThrow.fromX,
        ...
        var coordianteY = _rebound2.default.MathUtil.mapValueInRange(
          value,
          0,
          1,
          lastThrow.fromY,
    ...
    springThrowOut.addListener({
      ...
      onSpringUpdate: function onSpringUpdate(spring) {
        ...
        if (
          lastThrow.direction === _Direction2.default.RIGHT ||
          lastThrow.direction === _Direction2.default.LEFT
        ) {
          directionFactor =
            lastThrow.direction === _Direction2.default.RIGHT ? 1 : -1;
          coordianteX = _rebound2.default.MathUtil.mapValueInRange(
            value,
            0,
            1,
            lastThrow.fromX,
          ...
          lastThrow.direction === _Direction2.default.UP ||
          lastThrow.direction === _Direction2.default.DOWN
        ) {
          directionFactor =
            lastThrow.direction === _Direction2.default.DOWN ? 1 : -1;
          coordianteX = lastThrow.fromX;
          coordianteY = _rebound2.default.MathUtil.mapValueInRange(
            value,
            0,
            1,
            lastThrow.fromY,
...
Card.makeConfig = function() {
  ...
  var defaultConfig = {
    allowedDirections: [
      _Direction2.default.RIGHT,
      _Direction2.default.LEFT,
      _Direction2.default.UP
    ],
...
Card.transform = function(element, coordinateX, coordinateY, rotation) {
  element.style[(0, _vendorPrefix2.default)("transform")] =
